...
DEVC_IP = env.DEVC_TEMP_IP
DEVC_TCP_PORT = int(env.DEVC_TEMP_TCP_PORT)  # Porta para receber dados UDP de sensores
...
def send_udp_data():
    ...
    while True:
        ...
        sensor_data = {'TIPO': "SENSOR TEMPERATURA",'GRAUS': random.randint(20, 30)}
