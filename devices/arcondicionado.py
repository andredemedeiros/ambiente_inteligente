...
DEVC_IP = env.DEVC_AIR_IP
DEVC_TCP_PORT = int(env.DEVC_AIR_TCP_PORT)  # Porta para receber dados UDP de sensores
    ...
    while True:
        ...
        try:
            ...
            if msg != "ping":
                try:
                    level = int(msg)
                    print(f"Valor de level definido em: {level}")
                except ValueError:
...
def send_udp_data():
    ...
    while True:
        sensor_data = {'TIPO': "AR CONDICIONADO",'ESTADO': level}
